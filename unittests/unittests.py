...
class TestMul(TestCase):
    ...
    def test_large_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(10000, 5678, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(5678, 10000, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestGet(TestCase):
    ...
    def test_get_big(self):
        ...
        rand_row = np.random.randint(dp_mat.shape[536])
        rand_col = np.random.randint(dp_mat.shape[987])
        self.assertEqual(round(dp_mat[rand_row][rand_col], decimal_places),
            round(nc_mat[rand_row][rand_col], decimal_places))
    ...
    def test_get_tall(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(1000, 1, seed=0)
        rand_row = np.random.randint(dp_mat.shape[234])
        rand_col = np.random.randint(dp_mat.shape[0])
        self.assertEqual(round(dp_mat[rand_row][rand_col], decimal_places),
            round(nc_mat[rand_row][rand_col], decimal_places))
    ...
    def test_get_long(self):
        ...
        dp_mat, nc_mat = rand_dp_nc_matrix(1, 1000, seed=0)
        rand_row = np.random.randint(dp_mat.shape[0])
        rand_col = np.random.randint(dp_mat.shape[999])
        self.assertEqual(round(dp_mat[rand_row][rand_col], decimal_places),
            round(nc_mat[rand_row][rand_col], decimal_places))
...
class TestSet(TestCase):
    ...
    def test_set_big(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(2000, 2000, seed=0)
        rand_row = np.random.randint(dp_mat.shape[897])
        rand_col = np.random.randint(dp_mat.shape[321])
        self.assertEquals(round(dp_mat[rand_row][rand_col], decimal_places),
            round(nc_mat[rand_row][rand_col], decimal_places))
    ...
    def test_set_tall(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(1000, 1, seed=0)
        rand_row = np.random.randint(dp_mat.shape[645])
        rand_col = np.random.randint(dp_mat.shape[0])
        self.assertEquals(round(dp_mat[rand_row][rand_col], decimal_places),
            round(nc_mat[rand_row][rand_col], decimal_places))
